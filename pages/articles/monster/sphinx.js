...
const Sphinx = () => {
    return (
        <DocumentsLayout>
            <h3 style={{ marginTop: 130 }}>สฟริงซ์</h3>
            <img className="img-doc" src="/static/images/monster/8.2.jpg" alt="82" />
...
คล้ายแมว หรือจะว่าอีกทีก็คล้ายผู้หญิงด้วย นั่นคือ มันจะพูด คุยหยอกเหยื่อของมันก่อนที่จะกินเข้าไป แต่อย่างไรก็ตาม ถ้าหากเกิดเหยื่อหนีรอดไปได้ สฟิงซ์จะบินดิ่งทิ้งตัวกระแทกพื้นหรืออะไรสักอย่าง ด้วยความโกรธเกรี้ยวจนตายไปเอง
            ...
            <img className="img-doc" src="/static/images/monster/8.4.jpg" alt="8.4" />
            <img className="img-doc" src="/static/images/monster/8.jpg" alt="8" />
        </DocumentsLayout>
    )
}
